...
export default function HeroSection({ t }) {
  return (
    <section style={{display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',height:'80vh',textAlign:'center',background:'linear-gradient(135deg,#e0f0ff,#cce5ff)'}}>
      ...
      <div style={{display:'flex',gap:12}}>
        ...
        <Link href="/companions"><a style={{padding:'14px 28px',background:'#ff7f50',color:'#fff',borderRadius:6}}>{t('Real Companions','真人陪聊师')}</a></Link>
      </div>
    </section>
  );
}